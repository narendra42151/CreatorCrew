...
class BrandLoginWidget extends StatefulWidget {
  final VoidCallback onToggleView;

  const BrandLoginWidget({required this.onToggleView});

  @override
  _BrandLoginWidgetState createState() => _BrandLoginWidgetState();
}

class _BrandLoginWidgetState extends State<BrandLoginWidget> {
